System.register(['greensock', 'aurelia-templating', 'aurelia-pal', 'aurelia-binding'], function (_export) {
    'use strict';

    var animationEvent, TemplatingEngine, DOM, Parser, extendedEffects, GreensockAnimator;
    ...
    return {
        setters: [function (_greensock) {}, function (_aureliaTemplating) {
        ...
        execute: function () {
            ...
            _export('extendedEffects', extendedEffects);
            ...
            GreensockAnimator = (function () {
                ...
                GreensockAnimator.prototype.animate = function animate(element, nameOrProps) {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (!silent) {
                            _this._triggerDOMEvent(animationEvent.animateBegin, element);
                        }
